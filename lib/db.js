 ...
 * Safe to call when the database is unavailable — returns a degraded
 * status object instead of throwing, so /api/health stays reachable.
 */
function health() {
